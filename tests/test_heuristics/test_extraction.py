...
class TestExtraction():
    ...
    def test_architecture_aware_extraction_correctness(self):
        ...
        architecture = create_line_architecture(graph.qubit_count())
        graph_simp = graph.copy()
        new_circuit, new_architecture = extract_architecture_aware_circuit(graph=graph_simp, architecture=architecture, use_gate_mapping=False, up_to_perm=False, quiet=True)
